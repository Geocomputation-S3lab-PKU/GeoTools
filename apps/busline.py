...
from utils.download import get_geojson_file_downloader_html
...
def get_main(city, key, data):
    ...
    st.markdown(get_geojson_file_downloader_html(all_stop_df.to_json(), name='站点', file_label='站点Geojson'), unsafe_allow_html=True)
    ...
    st.markdown(get_geojson_file_downloader_html(merge_df.to_json(), name='线路', file_label='线路Geojson'), unsafe_allow_html=True)
